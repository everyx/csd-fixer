 ...
 * generating src/lib/mutterRules.generated.js.
 *
 * Design: narrow parser + assertions. Parses the default_shadow_classes array and algorithms,
 * computing shadow radius and spread distance to provide criteria for decoration and CSD boundary detection.
 *
...
function main() {
    ...
    const banner = `/**
 * mutterRules.generated.js - Automatically parsed and generated from vendor/mutter/meta-shadow-factory.c.
 *
